...
import javax.swing.*;
import controller.BasicTextEditor;
import controller.FileSearch;
import controller.GrepFrame;
import controller.HtmlProcessor;
import controller.ImageViewer;
import controller.JPanelDemo11;
import controller.WordProcessor;
import controller.WordProcessor11;
import controller.XmlViewer;
import controller.SearchFiles;
public class digireader extends JFrame {
	...
	public digireader() {
		...
		tabbedPane.setBounds(0, 46, 1010, 592);
		contentPane.add(tabbedPane);
		
		JTabbedPane tabbedPane_1 = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.addTab("                               Main Window                       ",new MainScreen());
		
		JTabbedPane tabbedPane_2 = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.addTab("                               File Search                       ", new FileSearch());
