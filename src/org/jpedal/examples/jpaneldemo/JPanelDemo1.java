...
public class JPanelDemo1 extends JInternalFrame {
	...
	private String viewerTitle = "Digital Reader-PDF";
	...
	private JTextField pageCounter2 = new JTextField(4);// 000 used to set
														// prefered size
	private JLabel pageCounter3 = new JLabel("of");// 000 used to set prefered
													// size

	/**
	 * construct a pdf viewer, passing in the full file name
	 */
	public JPanelDemo1(String name) {
	...
	private JButton initOpenBut() {
		...
		open.setIcon(new ImageIcon(getClass().getResource(
				"/org/jpedal/examples/simpleviewer/res/open.gif"))); //$NON-NLS-1$
		open.setText("Open");
